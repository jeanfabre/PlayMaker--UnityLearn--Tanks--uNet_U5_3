...
[Serializable]
public class PlayMakerSanPlayerManager
{
	// This class is to manage various settings on a player.
	// It works with the GameManager class to control how the players instance behave
	// and whether or not players have control of their prefab instance in the 
	...
	[HideInInspector]
	public GameObject m_PlayerRenderers;        // The transform that is a parent of all the player's renderers.  This is deactivated when the player is dead.
	[HideInInspector]
...
*/
	public void Setup()
	{
		Debug.Log("PlayMakerSanPlayerManager Setup()");
	...
	{
		return -1;//m_Setup.m_PlayerNumber
	}
	...
	public bool IsReady()
	{
		return false;// m_Setup.m_IsReady;
	}
